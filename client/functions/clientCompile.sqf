...
canBuildingLock = "addons\buildingLocker\canBuildingLock.sqf" call mf_compile;
canBuildingUnlock = "addons\buildingLocker\canBuildingUnlock.sqf" call mf_compile;
canChangePassword = "addons\buildingLocker\canChangePassword.sqf" call mf_compile;
canEnterPassword = "addons\buildingLocker\canEnterPassword.sqf" call mf_compile;
