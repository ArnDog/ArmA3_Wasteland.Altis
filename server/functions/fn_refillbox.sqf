...
switch (_boxType) do
{
	case "mission_USLaunchers":
	{
		...
		[
			...
			["mag", ["ClaymoreDirectionalMine_Remote_Mag", "SLAMDirectionalMine_Wire_Mag", "ATMine_Range_Mag", "DemoCharge_Remote_Mag"], RANDOM_BETWEEN(3,8)],
      ["mag", ["SatchelCharge_Remote_Mag"], RANDOM_BETWEEN(2,4)]
		];
	};
